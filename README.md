...
* Можно вызвать полный лог - git log или сокращённый лог —  git log --oneline.
## Про HEAD 
1. В папке .git есть служебный файл HEAD. Он указывает на самый свежий коммит.
...
* tracked (англ. «отслеживаемый»)
 - В него попадают файлы, которые уже были зафиксированы с помощью git commit, а также файлы, которые были добавлены в staging area командой git add. Т
* modified (англ. «изменённый»)
 - Git сравнил содержимое файла с последней сохранённой версией и нашёл отличия.
